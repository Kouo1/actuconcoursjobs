...
<body>
  ...
  <div id="bodyRegister">
            <form method="POST"  action="" id="formCreerUser">
                <fieldset>
                    ...
                    <fieldset>
                    <legend>Etes vous chercheur d'emploi ou employeur</legend>
                    <label for="candidat">Candidat(e)</label>
  <input type="radio" id="candidat" name="candidatOuEmployeur" value="candidat" checked>
  
  <label for="employeur">Employeur</label>
  <input type="radio" id="employeur" name="candidatOuEmployeur" value="employeur">
  
  </fieldset>
  
  <br>
                   <label for="domaineUser">Domaine </label>
                   <select id="selectMultiple" name="domaineUser[]" multiple="multiple" required>
  ...
  <br/>
                    ...
                    <input type="email" id="mail" name="mail" value="" size="30" placeholder="Votre adresse email" required />
                    <span class="email_feedback"></span>
                    <br/><br/>
                    
                    <label for="nom">Nom </label>
                     <input type="text" id="nom" name="nom" value="" size="30" placeholder="Votre nom" required />
        ...
        <select name="paysUtilisateur" id="paysUtilisateur" value="">
...
<option value="Zimbabwe">Zimbabwe </option>
         ...
         <span class="erreur"></span>
                    ...
                    <label for="mot_de_passeUtilisateur">Mot de passe </label>
                     <input type="password" id="mot_de_passeUtilisateur" name="mot_de_passeUtilisateur" value="" size="20" maxlength="20" required />
                     <span class="password_feedback"></span>
                    <br /><br><br>
                    
                    <label for="mot_de_passeUtilisateur_c">Confirmer le mot de passe </label>
                     <input type="password" id="mot_de_passeUtilisateur_c" name="mot_de_passeUtilisateur_c" value="" size="20" maxlength="20" required/>
                     ...
                     <div id="label2">
                         ...
                         <input type="checkbox" name="conditionsUse" id="conditionsUse" value="on" required/>
                         <label for="conditionsUse">J'accepte<a href="conditions_utilisations_fr.php" target="_blank"> les conditions d'utilisations</a><span class="requis">*</span>
                         <span class="erreur"></span>
                         </label>
                     </div>  
                     <br><br><br><br>
